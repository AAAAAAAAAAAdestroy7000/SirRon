<?php
// success and error messages are passed using GET
// this allows registercheck.php to redirect back with feedback
...
<div class="register-container">
    <div class="register-box">
        ...
        <p class="footer-text">
            Already have an account? <a href="/WWW/Pages/login.php">Sign in</a>
        </p>
...
function handleCredentialResponse(response) {
    ...
    form.method = 'POST';
    form.action = '/WWW/inserts/google_register.php';
